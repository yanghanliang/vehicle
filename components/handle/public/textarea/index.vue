<template>
    ...
    >
        ...
        <u-form-item label="文字跳转链接">
            <u-input v-model="form.href" />
        </u-form-item>
        <u-form-item label="模块上间距">
			<u-input v-model="form.marginTop" /></u-form-item>
